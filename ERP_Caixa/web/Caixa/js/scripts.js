...
function popup_error(){
    ...
    var conteudo = "<div id='myModal' class='modal'> <div class='modal-content' style='border-radius:10px;'> <span class='close' onClick='fecha_popup()'>&times;</span> <h3>ERRO</h3> <center>Erro na operação!</center><br> <div class='clearfix'></div> </div> </div>";
